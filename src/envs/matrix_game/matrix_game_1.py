...
class Matrix_game1Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.matrix_table = np.array([[first_weight, 0, 10],
                                      [0, 10, 10],
                                      [10, 10, 10]])

        # self.actions = np.array([1, 0, 0, 1, 0, 0])
    ...
    def get_obs_agent(self, agent_id):
        ...
        return np.concatenate(self.matrix_table)
    ...
    def get_state(self):
        ...
        # return np.array([self._episode_steps])
        tmp = np.concatenate(self.matrix_table)
        # tmp = np.concatenate([tmp, self.actions])
        # print(tmp)
        return tmp
