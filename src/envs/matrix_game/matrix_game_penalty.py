...
class Matrix_Game_Penalty_Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        assert k < 10
        self.matrix_table = np.array([[10, 0, k], [0, 2, 0], [k, 0, 10]])
    ...
    def step(self, actions):
        ...
        terminated = False
        if (actions[0] == 0 and actions[1] == 2) or (actions[0] == 2 and actions[1] == 0):
