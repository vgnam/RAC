...
class Matrix_Game_Fully_Stochastic_Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.matrix_table = np.array([[[10, 12], [-65, 5], [8, -8]], [[-65, 5], [14, 0], [12, 0]], [[8, -8], [12, 0], [10, 0]]])
    ...
    def step(self, actions):
        ...
        reward = np.random.choice(self.matrix_table[actions[0]][actions[1]])
